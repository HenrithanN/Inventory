...
const handleSubmit = event =>{
  ...
  return (
    ...
    <form align="center" onSubmit={handleSubmit} >
      ...
      <Typography color="textSecondary"variant="h5">Formulario para Cadastro de novos Fornecedores</Typography>
      ...
      <div align="center">
      <Button variant="contained" color="primary" size="large" type="submit"onClick={createProvider}>
